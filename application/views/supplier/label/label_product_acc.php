...
$this->db->where('po_detail.po_detail_id',$po_detail_id);
...
?>
	<div class="outer">
		...
		<div class="isi">
			<div class="isi1">
				NO CARTON : <span style="font-size: 24px"><?=$num;?></span> / <?=$b->qty_carton;?>
			</div>
			<div class="isi1">
				<?=$b->item;?>
			</div>
			<div class="isi1">
				ORDER: <?=number_format($b->qtyordered,2);?> || DLVRD: <?=number_format($b->qty_upload,2);?> <?=$b->uomsymbol;?>
			</div>
			...
			<div class="isi2">
				...
				<div class="block-kiri" style="margin-top: 6px">
					PL/INV: <span style="font-size: 16px"><?=$b->no_packinglist;?></span>
				</div>
			</div>
			<div class="isi3">
				<div class="block-kiri" style="height: 120px;">
					<svg id="id<?=$b->po_detail_id;?>" onload='return barcode("id<?=$b->po_detail_id;?>","<?=$b->po_detail_id;?>")'></svg>
				</div>
				<div class="block-kiri" style="margin-top: 6px;" >
					DESC: <span style="font-size: 16px"><?=$b->pobuyer;?></span>
				</div>
			</div>
		</div>		
	</div>
