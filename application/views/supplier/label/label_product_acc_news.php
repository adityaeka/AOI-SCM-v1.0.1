...
<body>
<?php
$this->db->join('po_detailline','po_detailline.c_orderline_id = po_detail.c_orderline_id','RIGHT');
...
$this->db->select('*,po_detailline.poreference AS pob');
...
?>
	<div class="outer">
		...
		<div class="isi">
			<div class="isi1">
				NO PACKAGE : <span style="font-size: 24px"><?=($b->qty_carton);?>
			</div>
			<div class="isi1">
			...
			<div class="isi3">
				<div class="block-kiri" style="height: 120px;">
					<svg id="id<?=$b->po_detailline_id;?>" onload='return barcode("id<?=$b->po_detailline_id;?>","<?=$b->po_detailline_id;?>")'></svg>
				</div>
				<div class="block-kiri" style="margin-top: 6px;" >
