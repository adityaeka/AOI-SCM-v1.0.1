...
<?php
	...
	$this->db->where('po_detail.no_packinglist',$nopl);
	$this->db->where('po_detail.kst_suratjalanvendor',$sj);
	$this->db->where('po_detail.kst_invoicevendor',$inv);
	$this->db->where('po_detail.kst_resi',$awb);
