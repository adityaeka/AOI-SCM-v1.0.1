		...
		<table class="table table-striped table-bordered" id="tables">
			...
			<tbody>
				<?php
					...
					$pl='';
					$this->db->distinct();
					$this->db->select('supplier, no_packinglist, kst_suratjalanvendor,kst_invoicevendor, kst_resi, type_po, is_locked');
					//$this->db->group_by('no_packinglist, kst_suratjalanvendor, kst_invoicevendor, kst_resi, type_po, is_locked');
					$this->db->order_by('supplier, no_packinglist, kst_invoicevendor');
